...
interface RevogrViewportScrollProps {
  ...
  /**  */
  colType?: Components.RevogrViewportScroll["colType"]
}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			set_custom_element_data(revogr_viewport_scroll, "col-type", /*colType*/ ctx[3]);
		},
		m(target, anchor) {
			...
			/*revogr_viewport_scroll_binding*/ ctx[12](revogr_viewport_scroll);
			current = true;

			if (!mounted) {
				dispose = [
					listen(revogr_viewport_scroll, "scrollviewport", /*onEvent*/ ctx[5]),
					listen(revogr_viewport_scroll, "resizeviewport", /*onEvent*/ ctx[5]),
					listen(revogr_viewport_scroll, "scrollchange", /*onEvent*/ ctx[5]),
					listen(revogr_viewport_scroll, "scrollviewportsilent", /*onEvent*/ ctx[5])
				];
		...
		d(detaching) {
			...
			/*revogr_viewport_scroll_binding*/ ctx[12](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('colType' in $$props) $$invalidate(3, colType = $$props.colType);
